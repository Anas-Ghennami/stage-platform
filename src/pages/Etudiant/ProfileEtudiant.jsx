    ...
    return (
        ...
        <div id="page_etudiant_stages" className="min-h-screen bg-slate-200/30">
            ...
            <header id="header_dashboard" className="p-7">
                <div id="header_text">
                    <h1 id="header_title" className="text-2xl font-[700]  text-slate-800 ">Mon profil</h1>
                    <p id="header_subtitle" className="text-gray-500 py-1 sm:text-[10px] md:text-[12px] lg:text-[14px]">Gérez vos informations personnelles et académiques.</p>
                </div>
            </header>
