...
const SideBar = ({ role, openSidebar, setOpenSidebar }) => {
    ...
    const menuByRole = {
        ...
        entreprise: [
            ...
            {
                id: "menu_entreprise_createOffre",
                name: "Nouvelle offre",
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
    ...
    // !! FAKE: role vient du front (backend plus tard)
        ...
        >
            ...
            <div id="sidebar_header" className="flex items-center gap-3 mb-6 pr-5 pl-5 pt-5">
                ...
                <div id="logo_text" className="flex flex-col">
                    ...
                    <span id="logo_subtitle" className="text-gray-400 text-xs tracking-widest mt-1">
                        STAGE PLATFORM
                    </span>
                </div>
            ...
            {/* SEPARATOR */}
            <hr className="border-gray-400/20  mb-1" />

            {/* LINKS SECTION (just example space) */}
            <div id="menu_container" className="flex flex-col gap-4 p-2">

                <ul id="menu_list" className="flex flex-col gap-3">
                    {menu.map((item) => (
                        <li key={item.id}>
                            <NavLink
                                id={item.id}
            ...
            {/* FOOTER */}
            <div id="sidebar_footer" className="mt-auto  text-gray-400 text-sm pb-6">
                <hr className="border-gray-400/20  mb-6" />
                <span id="role_label" className="px-[10%] hover:text-gray-300 hover:bg-gray-500/10 rounded-3xl py-[2.3%] transition hover:animate-pulse mr-2">{role.toUpperCase()}</span>
            </div>
        </div>
    );
}
